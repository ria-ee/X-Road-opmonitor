""" MongoDB script - Collector State

Usage example:

> python create_indexes_collector.py collector_state_sample root --auth admin --host 127.0.0.1:27017
...
def main():
    ...
    mdb_indexes = list()
    mdb_indexes.append(('server_list', [('timestamp', -1)]))

    print('* Creating collector_state.server_list MongoDB indexes:')
    i_list = []
