""" MongoDB script - Reports State

Usage example:

> python create_indexes_reports.py reports_state_sample root --auth admin --host 127.0.0.1:27017
...
def main():
    parser = argparse.ArgumentParser(description='MongoDB script - Reports Database')
    ...
    mdb_indexes = list()
    mdb_indexes.append(('notification_queue', [('status', 1), ('user_id', 1)]))

    print('* Creating reports_state.notification_queue MongoDB indexes:')
    i_list = []
