...
if __name__ == '__main__':
    ...
    logger_m.log_error('running_cron_interannual_factsheet', args[1])
    logger_m.log_heartbeat('running_cron_interannual_factsheet: {0}'.format(args[1]), settings.HEARTBEAT_LOGGER_PATH,
